...
//=====================================================================
static int screen_w, screen_h, screen_exit = 0;
static int screen_keys[512];	// 当前键盘按下状态
static unsigned char *screen_fb = NULL;		// frame buffer
static int screen_mx = 0, screen_my = 0, screen_mb = 0;
static HWND screen_handle = NULL;		// 主窗口 HWND
static HDC screen_dc = NULL;			// 配套的 HDC
static HBITMAP screen_hb = NULL;		// DIB
static HBITMAP screen_ob = NULL;		// 老的 BITMAP
static long screen_pitch = 0;
...
#ifndef __linux
// 初始化窗口并设置标题
static int screen_init(int w, int h, const TCHAR *title) {
